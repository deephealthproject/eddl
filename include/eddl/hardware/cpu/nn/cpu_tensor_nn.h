...
void cpu_new_conv2D(ConvolDescriptor *D, float *ptrO);
void cpu_new_conv2D_grad(ConvolDescriptor *D, float *output);
void cpu_new_conv2D_back(ConvolDescriptor *D, float *output);
