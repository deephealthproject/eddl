...
//
//    // Mean
//    auto *ptr_mean_ref = new float[3]{-0.196,  0.058,  0.370};
//    auto* t_mean_ref = new Tensor({3}, ptr_mean_ref, DEV_CPU);
//
//    // Var
//    const float epsilon = 1e-5;
//    auto *ptr_var_ref = new float[3]{0.914, 1.098, 0.520};
...
//
////    t_output->print(2.0f);
//    ASSERT_TRUE((bool) Tensor::equivalent(t_fwrd_ref, t_output, 1e-3f, 0.0f, true, true));
//
////    t_mean->print(2.0f);
//    ASSERT_TRUE((bool) Tensor::equivalent(t_mean_ref, t_mean, 1e-3f, 0.0f, true, true));
//
////    t_var->print(2.0f);
//    ASSERT_TRUE((bool) Tensor::equivalent(t_var_ref, t_var, 1e-3f, 0.0f, true, true));
//}
