...
int main(int argc, char **argv) {
    ...
    // TEST: full
    cout << "\n" << "full: =============" << endl;
    t = Tensor::full({10, 5}, 7.0, dev);
    t->info();
    t->print();

    // TEST: arange
    cout << "\n" << "arange: =============" << endl;
    t = Tensor::arange(1.0, 2.5, 0.5, dev);
    t->info();
    t->print();

    // TEST: range
    cout << "\n" << "range: =============" << endl;
    t = Tensor::range(1.0, 4.0, 0.5, dev);
    t->info();
    t->print();

    // TEST: Linear space
    cout << "\n" << "linspace: =============" << endl;
    t = Tensor::linspace(0.1, 1.0, 5, dev);
    t->info();
    t->print();

    // TEST: Linear space
    cout << "\n" << "logspace: =============" << endl;
    t = Tensor::logspace(0.1, 1.0, 5, 10.0, dev);
    t->info();
    t->print();
    ...
    // TEST: ones
    cout << "\n" << "abs: =============" << endl;
    t = Tensor::range(-5.0, 5.0, 1.0, dev);
    t->print();
    t->abs_();
    t->print();
    ...
    // TEST: ceil
    cout << "\n" << "ceil: =============" << endl;
    t = Tensor::range(-2.0, 2.0, 0.25, dev);
    t->print();
    t->ceil_();
    t->print();
    ...
    // TEST: normalize
    cout << "\n" << "normalize: =============" << endl;
    cout << "CPU: " << DEV_CPU << endl;
    cout << "GPU: " << DEV_GPU << endl;
    cout << "Tensor device:" << t->device << endl;
    t = Tensor::range(-5.0, 5.0, 1.0, dev);
    t->print();
    ...
    // TEST: sub
    cout << "\n" << "sum: =============" << endl;
    t = Tensor::range(0.0, 10.0, 1.0, dev);
    t->print();
    cout << "sum:" << t->sum() << endl;
    t->print();
