...
int main(int argc, char **argv) {
  ...
  string onnx_model_path("model_test_onnx_lstm_enc_dec.onnx");
  string target_metric_file("metric_test_onnx_lstm_enc_dec.txt");
