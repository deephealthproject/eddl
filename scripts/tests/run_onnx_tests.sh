...
#    popd > /dev/null  # Go back to py_scripts main folder
    ...
    keras2eddl+=("Keras_to_EDDL_dilated_conv1D;test_onnx_keras_dilated_conv1D;export_scripts/dilated_conv1D_keras_export.py;test_onnx_dilated_conv1D,--import")
    keras2eddl+=("Keras_to_EDDL_dilated_conv2D;test_onnx_keras_dilated_conv2D;export_scripts/dilated_conv2D_keras_export.py;test_onnx_dilated_conv2D,--import")
    keras2eddl+=("Keras_to_EDDL_dilated_conv3D;test_onnx_keras_dilated_conv3D;export_scripts/dilated_conv3D_keras_export.py;test_onnx_dilated_conv3D,--import,--channels-last")
    ...
    #keras2eddl+=("Keras_to_EDDL_dilated_conv1D_CPU;test_onnx_keras_dilated_conv1D;none;test_onnx_dilated_conv1D,--import,--cpu") Dilated conv only available with CUDNN
    #keras2eddl+=("Keras_to_EDDL_dilated_conv2D_CPU;test_onnx_keras_dilated_conv2D;none;test_onnx_dilated_conv2D,--import,--cpu") Dilated conv only available with CUDNN
    #keras2eddl+=("Keras_to_EDDL_dilated_conv3D_CPU;test_onnx_keras_dilated_conv3D;none;test_onnx_dilated_conv3D,--import,--cpu,--channels-last") Dilated conv only available with CUDNN
