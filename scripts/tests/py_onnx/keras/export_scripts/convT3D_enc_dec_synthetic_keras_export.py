...
# Training settings
parser = argparse.ArgumentParser(description='Keras ConvT3D encoder decoder with synthetic data Example')
...
model.add(MaxPooling3D(2, 2))
# Decoder
model.add(Conv3DTranspose(64, 2, strides=(2, 2, 2), padding="same", activation='relu'))
model.add(Conv3D(32, 1, padding="same", activation="relu"))
model.add(Conv3DTranspose(32, 2, strides=(2, 2, 2), padding="same", activation='relu'))
