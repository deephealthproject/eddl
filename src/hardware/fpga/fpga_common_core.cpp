...
void fpga_init(int kernel_version, int kernel_subversion) {
  ...
  if ((kernel_version == 1) && (kernel_subversion == 0)) {
    ...
    hlsinf_dense_support = false; hlsinf_weight_buffer = 4096; hlsinf_data_buffer = 16384;
    printf("------------------------------------------------------------------------------------------------------------------------------\n");
    ...
    hlsinf_avgp_support = true;  hlsinf_bn_support = false;    hlsinf_bn_relu_support = false; hlsinf_add_support = true; hlsinf_add_relu_support = false; 
    ...
    hlsinf_conv_support = true;  hlsinf_shift_support = true; hlsinf_clip_support = true;
    hlsinf_relu_support = true;  hlsinf_stm_support = false;  hlsinf_maxp_support = true;
    hlsinf_avgp_support = true;  hlsinf_bn_support = false;   hlsinf_bn_relu_support = false; hlsinf_add_support = false; hlsinf_add_relu_support = false; 
    hlsinf_upsize_support = false;  hlsinf_dense_support = false;
    printf("------------------------------------------------------------------------------------------------------------------------------\n");
