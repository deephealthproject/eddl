...
// GPU: Tensor
__global__ void repeat_nn(float *a, int a_rows, int a_cols, float *b, int b_rows, int b_cols, int *size, int size_length);
__global__ void d_repeat_nn(float *d, int d_rows, int d_cols, float *a, int a_rows, int a_cols, int *size, int size_length);
