...
__global__ void crop_scale_random(float* A, float* B, int batch, int depth, int irows, int icols, int orows, int ocols, float constant, float* rdn);
__global__ void cutout_random(float* A, float* B, int batch, int depth, int irows, int icols, float constant, float* rdn);
