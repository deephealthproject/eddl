...
#ifndef _EDDL_BINDER_
#define _EDDL_BINDER_
...
public:
    ...
    static tensor T(const vector<int> &shape, float *ptr);
    ...
    static layer Conv(layer parent, int filters, const vector<int> &kernel_size,
    ...
    static layer ConvT(layer parent, int filters, const vector<int> &kernel_size,
    ...
    static layer Input(const vector<int> &shape, string name="");

    // TODO: Interpolate, Resize, upsampling (downsampling?)
    static layer UpSampling(layer parent, const vector<int> &size, string interpolation="nearest", string name=""); //Todo: Implement

    static layer Reshape(layer parent, const vector<int> &shape, string name="");

    static layer Transpose(layer parent, const vector<int> &dims, string name=""); //Todo: Implement
    ...
    // ---- MERGE LAYERS ----
    static layer Add(const vector<layer> &layers, string name="");

    static layer Average(const vector<layer> &layers, string name=""); //Todo: Implement

    static layer Concat(const vector<layer> &layers, string name="");

    static layer MatMul(const vector<layer> &layers, string name=""); //Todo: Implement

    static layer Maximum(const vector<layer> &layers, string name=""); //Todo: Implement

    static layer Minimum(const vector<layer> &layers, string name=""); //Todo: Implement

    static layer Subtract(const vector<layer> &layers, string name=""); //Todo: Implement
    ...
    static layer ReduceMean(layer l, vector<int> axis);
    static layer ReduceMean(layer l, bool keepdims);
    static layer ReduceMean(layer l, vector<int> axis, bool keepdims);
    static layer ReduceVar(layer l);
    static layer ReduceVar(layer l, vector<int> axis);
    static layer ReduceVar(layer l, bool keepdims);
    static layer ReduceVar(layer l, vector<int> axis, bool keepdims);
    static layer ReduceSum(layer l);
    static layer ReduceSum(layer l, vector<int> axis);
    static layer ReduceSum(layer l, bool keepdims);
    static layer ReduceSum(layer l, vector<int> axis, bool keepdims);
    static layer ReduceMax(layer l);
    static layer ReduceMax(layer l, vector<int> axis);
    static layer ReduceMax(layer l, bool keepdims);
    static layer ReduceMax(layer l, vector<int> axis, bool keepdims);
    static layer ReduceMin(layer l);
    static layer ReduceMin(layer l, vector<int> axis);
    static layer ReduceMin(layer l, bool keepdims);
    static layer ReduceMin(layer l, vector<int> axis, bool keepdims);

    // ---- GENERATOR LAYERS ----
    static layer GaussGenerator(float mean, float stdev, vector<int> size);
    static layer UniformGenerator(float low, float high, vector<int> size);
    ...
    static void change(optimizer o, vector<float> &params);


    // ---- POOLING LAYERS ----
    static layer AveragePool(layer parent, const vector<int> &pool_size);
    static layer AveragePool(layer parent, const vector<int> &pool_size, const vector<int> &strides, string padding="none", string name="");
    ...
    static layer MaxPool(layer parent, const vector<int> &pool_size, string padding="none", string name="");
    static layer MaxPool(layer parent, const vector<int> &pool_size, const vector<int> &strides, string padding="none", string name="");
...
//    static callback MultiStepLR(const vector<int> &milestones, float gamma, int last_epoch); //Todo: Implement
...
//    static callback StepLR(int step_size, float gamma, int last_epoch); //Todo: Implement
    ...
    static compserv CS_GPU(const vector<int> &g);
    static compserv CS_FGPA(const vector<int> &f);

    // ---- MODEL METHODS ----
    static model Model(vlayer in, vlayer out);

    static void build(model net, optimizer o, const vector<Loss *> &lo, const vector<Metric *> &me);
    static void build(model net, optimizer o, const vector<Loss *> &lo, const vector<Metric *> &me, CompServ *cs);
    ...
    static void fit(model m, const vector<LTensor *> &in, const vector<LTensor *> &out, int batch, int epochs);
    static void evaluate(model m, const vector<LTensor *> &in, const vector<LTensor *> &out);
    static void predict(model m, const vector<LTensor *> &in, const vector<LTensor *> &out);
...
extern EDDL_BINDER eddl_binder;
