...
namespace eddl {
    ...
    // ---- POOLING LAYERS ----
    layer AveragePool(layer parent, const vector<int> &pool_size={2,2}, const vector<int> &strides={1,1}, string padding="none", string name="");
    ...
    layer MaxPool(layer parent, const vector<int> &pool_size={2,2}, const vector<int> &strides={1,1}, string padding="none", string name="");
