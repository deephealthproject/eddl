...
HD_PWD='/home/jorga20j/test_fpga/simple_vadd/_x.sw_emu.xilinx_u200_xdma_201830_2/kernel_relu/k_relu'
cd "$HD_PWD"
...
EAStep vivado_hls -f k_relu.tcl -messageDb vivado_hls.pb
