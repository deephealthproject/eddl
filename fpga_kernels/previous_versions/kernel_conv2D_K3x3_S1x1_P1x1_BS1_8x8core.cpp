...
void k_conv2D_8x8
                                (
                                 ...
                                 int enable_read0, int enable_read1, int enable_read2, int enable_read3,
                                 int enable_read4, int enable_read5, int enable_read6, int enable_read7,
                                 ...
                                 int enable_write0, int enable_write1, int enable_write2, int enable_write3,
                                 int enable_write4, int enable_write5, int enable_write6, int enable_write7,
  ...
  #pragma HLS INTERFACE s_axilite port=enable_read0 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read1 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read2 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read3 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read4 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read5 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read6 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_read7 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write0 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write1 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write2 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write3 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write4 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write5 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write6 bundle=control
  #pragma HLS INTERFACE s_axilite port=enable_write7 bundle=control
