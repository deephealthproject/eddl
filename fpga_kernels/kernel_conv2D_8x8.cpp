...
void k_conv2D_8x8
  ...
  for (int o_iter = 0; o_iter<O_ITER; o_iter++) {
    ...
    int offset_read_data_channel_4 = channel_offset * 4;
    int offset_read_data_channel_5 = channel_offset * 5;
    int offset_read_data_channel_6 = channel_offset * 6;
    int offset_read_data_channel_7 = channel_offset * 7;
    ...
    read_data_channel(H, W, I_ITER, ptr_data4, offset_read_data_channel_4, out_read_channel_4, enable_read4, 4);
    read_data_channel(H, W, I_ITER, ptr_data5, offset_read_data_channel_5, out_read_channel_5, enable_read5, 5);
    read_data_channel(H, W, I_ITER, ptr_data6, offset_read_data_channel_6, out_read_channel_6, enable_read6, 6);
    read_data_channel(H, W, I_ITER, ptr_data7, offset_read_data_channel_7, out_read_channel_7, enable_read7, 7);
    join(H, W, I_ITER, out_read_channel_0, out_read_channel_1, out_read_channel_2, out_read_channel_3, out_read_channel_4, out_read_channel_5, out_read_channel_6, out_read_channel_7, out_read_data);
    ...
    write_data_channel(H, W, ptr_out4, offset_write_data_channel_4, out_write_channel_4, enable_write4, 4);
    write_data_channel(H, W, ptr_out5, offset_write_data_channel_5, out_write_channel_5, enable_write5, 5);
    write_data_channel(H, W, ptr_out6, offset_write_data_channel_6, out_write_channel_6, enable_write6, 6);
    write_data_channel(H, W, ptr_out7, offset_write_data_channel_7, out_write_channel_7, enable_write7, 7);
